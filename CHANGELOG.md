...
### 🐛 Bug Fixes
- Recover legacy Linux runtimes and guide other upgrades by @xizhibei in [#549](https://github.com/1mcp-app/agent/pull/549)


## [0.38.1] - 2026-09-19

### 🚀 Features
- Explain upstream HTTP EOF tool failures by @xizhibei in [#539](https://github.com/1mcp-app/agent/pull/539)

### 🐛 Bug Fixes
- Recover runtime scope after container PID reuse by @xizhibei in [#546](https://github.com/1mcp-app/agent/pull/546)
- Preserve capabilities on stdio supervisor recovery by @cq-guojia in [#548](https://github.com/1mcp-app/agent/pull/548)
- Preserve OAuth Admin returns and enforce inspect pagination by @xizhibei in [#544](https://github.com/1mcp-app/agent/pull/544)

### 📚 Documentation
- Enhance documentation with verification guidelines and new research insights by @xizhibei

## New Contributors
* @cq-guojia made their first contribution in [#548](https://github.com/1mcp-app/agent/pull/548)
...
- Supervise background runtimes and enforce exclusive runtime scope by @xizhibei in [#390](https://github.com/1mcp-app/agent/pull/390)
...
### 🚜 Refactor
- Refine architecture runtime boundaries by @xizhibei in [#326](https://github.com/1mcp-app/agent/pull/326)
...
### ⚙️ Miscellaneous Tasks
- Update E2E test reporter to minimal and increase timeout for format options test by @xizhibei
- Upgrade vitest by @xizhibei


## [0.32.0] - 2026-05-19

### 🚀 Features
- Add MCP tools commands for managing individual tool states by @xizhibei in [#319](https://github.com/1mcp-app/agent/pull/319)
- Add MCP tools management commands by @xizhibei in [#297](https://github.com/1mcp-app/agent/pull/297)

### 🐛 Bug Fixes
- Harden browser-origin security boundaries by @xizhibei in [#315](https://github.com/1mcp-app/agent/pull/315)
- Include pnpm-workspace.yaml in Dockerfile for dependency installation by @xizhibei
- Allow esbuild builds in pnpm workspace config by @xizhibei in [#306](https://github.com/1mcp-app/agent/pull/306)
...
### ⚙️ Miscellaneous Tasks
- Update noEmit option in tsconfig files for build configuration by @xizhibei
...
### 🚀 Features
- Add mock SSE server for reproducing issue #255 and update notification handling by @xizhibei in [#256](https://github.com/1mcp-app/agent/pull/256)


## [0.30.0] - 2026-03-02

### 🚀 Features
- Implement lazy loading for MCP server tools by @xizhibei in [#221](https://github.com/1mcp-app/agent/pull/221)

### 📚 Documentation
- Add MCP server templates and Serena integration guides by @xizhibei in [#242](https://github.com/1mcp-app/agent/pull/242)
...
### 🚀 Features
- Restorable streamable HTTP sessions with enhanced logging by @xizhibei in [#231](https://github.com/1mcp-app/agent/pull/231)
...
### 🐛 Bug Fixes
- Start new HTTP transport during recreation to prevent 'Transport closed' errors by @xizhibei
- Refine pre-release detection logic in changelog configuration by @xizhibei
- Adjust git-cliff args and change filter_unconventional setting by @xizhibei
...
### 🚀 Features
- Add comprehensive MCP server management system by @xizhibei in [#187](https://github.com/1mcp-app/agent/pull/187)
...
- Fix incorrect binary names in installation guide by @do-not-do-that in [#194](https://github.com/1mcp-app/agent/pull/194)

### ⚙️ Miscellaneous Tasks
- Update stale issue and PR settings to reduce inactivity thresholds by @xizhibei

## New Contributors
* @do-not-do-that made their first contribution in [#194](https://github.com/1mcp-app/agent/pull/194)
...
### 🚀 Features
- Implement robust JSON schema validation with automatic error recovery by @xizhibei in [#175](https://github.com/1mcp-app/agent/pull/175)


## [0.27.2] - 2025-11-18

### ⚙️ Miscellaneous Tasks
- Update macOS build environment to macos-15-intel by @xizhibei


## [0.27.1] - 2025-11-18

### 🐛 Bug Fixes
- Update conflict logging for notification capabilities by @xizhibei

### 🚜 Refactor
- Introduce CompatibleRateLimitOptions interface for express-rate-limit v8 compatibility by @xizhibei

### ⚙️ Miscellaneous Tasks
- Update .gitignore to include /specs and /openspec directories by @xizhibei
